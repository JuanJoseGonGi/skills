...
2. Context-Specific Rules: Apply rules from references/ directory based on the language of the feature being implemented using the table given below:
...
The security rules are available in the `references/` directory.
